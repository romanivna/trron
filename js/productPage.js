fetch('jsons/drinks.json')
  ...
  .then(data => {
    ...
    // document.getElementsByClassName("product-properties--brand")[0].innerHTML = data["drinks"][productId].?;
    // document.getElementsByClassName("product-properties--brand")[0].href = "#"+data["drinks"][productId].?;
    
    // document.getElementsByClassName("product-properties--manufacturer")[0].innerHTML = data["drinks"][productId].?;
    // document.getElementsByClassName("product-properties--manufacturer")[0].href = "#"+data["drinks"][productId].?;
